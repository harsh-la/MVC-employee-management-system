						...
						<div class="row register-form">
							<div class="col-md-6">
								<div class="form-group">
									<input hidden="hidden" type="text" name="eid" class="form-control"
										placeholder="Enter Eid *" value="${employee.eid}" />
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<input type="text" name="salary" minlength="5" maxlength="10"
										name="" class="form-control" placeholder="Salary *"
							...
							<div class="col-md-6">
								<div class="form-group">
									<select name="type" class="form-control">
										...
										<option class="hidden" disabled>Type</option>
								...
								<div class="form-group">
									<input name="answer" type="text" class="form-control"
										placeholder="Enter Your Answer *" value="${employee.answer}" />
								</div>
